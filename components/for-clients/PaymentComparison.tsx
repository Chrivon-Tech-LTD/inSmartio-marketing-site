...
export const PaymentComparison: React.FC = () => {
   ...
   */
  return (
    <section className="py-16 md:py-24 bg-[#060D1A] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <Card className="p-8 md:p-12 border-2 border-success bg-[#0E1E3A] relative shadow-xl overflow-hidden group transition-all duration-500 rounded-[2.5rem] md:rounded-[3rem]">
            ...
            <div className="bg-[#060D1A]/50 p-5 rounded-2xl border border-success/20 shadow-sm">
          ...
          <Card className="p-8 md:p-12 border-2 border-secondary bg-[#0E1E3A] relative shadow-lg transition-all duration-500 rounded-[2.5rem] md:rounded-[3rem] group">
            ...
            <div className="bg-[#060D1A]/50 p-5 rounded-2xl border border-secondary/20 shadow-sm">
