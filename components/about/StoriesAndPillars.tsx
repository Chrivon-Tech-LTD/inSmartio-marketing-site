          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-4 pt-12">
            ...
            >
              ...
              <p className="text-sm font-bold text-text-main leading-relaxed">
                inSmartio bridges this gap. We&#39;re building Nigeria&lsquo;s most trusted service marketplace where every professional is
                verified, every transaction is transparent, and every user is empowered.
              </p>
            </motion.div>
          </div>
        </div>
