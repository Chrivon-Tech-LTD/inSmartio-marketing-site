...
export const Values = () => {
  ...
  return (
    <section className="relative py-16 md:py-28 bg-background transition-colors duration-300 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 md:w-175 md:h-175 bg-primary/10 blur-3xl rounded-full opacity-30" />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          <h2 className="mt-6 text-3xl md:text-5xl font-bold text-text-main leading-tight md:leading-tight">
            Built on Trust. <br />
            <span className="text-text-muted">Backed by Verification.</span>
          </h2>
        </div>

        {/* FEATURED CARD - Full width on all screens */}
        {featured && (
          <div className="mb-6 md:mb-10 p-6 md:p-8 rounded-2xl bg-surface border border-text-muted/10 flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-4 md:gap-6 hover:shadow-2xl transition-all">
        ...
        <div className="grid grid-cols-12 gap-6">
          {/* Left Column: Larger stacked cards on Desktop, single cards on Mobile */}
          ...
          {/* Right Column: 2x2 grid on Tablet/Desktop, single column on Mobile */}
...
const Card = ({ icon: Icon, title, desc, large = false }: CardProps) => {
  return (
    <div
      ...
      ${large ? "lg:h-full lg:justify-center" : "h-full"}
    `}
    >
      <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-secondary/10 mb-4 shrink-0">
